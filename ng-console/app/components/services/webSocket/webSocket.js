...
angular.module('app.components.services.webSocket', ['ui.notify', 'app.components.services.visibly', 'app.settings'])
      ...
      $get: function ($q,  $rootScope, $timeout, notificationService, $WebSocket, visibly, $log, settings, $window) {
        ...
        return {
          ...
          subscribe: function (topic, callback, $scope) {
            ...
            // If a $.Callbacks object has not been created for this
