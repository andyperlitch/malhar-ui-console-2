...
var datatorrent = {
    ...
    lib: {
        ...
        BaseEpoxyView                : require('./BaseEpoxyView'),
        ...
        ContainerLogCollection       : require('./ContainerLogCollection'),
        ContainerLogModel            : require('./ContainerLogModel'),
        ...
        PhysicalOperatorCollection   : require('./PhysicalOperatorCollection'),
        PhysicalOperatorModel        : require('./PhysicalOperatorModel'),
