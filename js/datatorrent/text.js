...
var textHash = {
    ...
    'log_level_level_label'      :  'log level',
    'log_level_target_label'     :  'target',
    'logs_label'                 :  'logs',
    ...
    'log_level_level_desc'       :  'The logging level to set target to.',
    'log_level_target_desc'      :  'This can be fully qualified Java class name, e.g. com.datatorrent.lib.io.ConsoleOutputOperator, or it can specify a package using wildcard notation, e.g. com.datatorrent.lib.io.*.',
    'gc_log'                     :  'GC log',
    'inspect'                    :  'inspect',
